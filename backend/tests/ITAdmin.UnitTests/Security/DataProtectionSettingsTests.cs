...
public sealed class DataProtectionSettingsTests
{
    ...
    public void Load_reads_configured_values_and_trims_them()
    {
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["DataProtection:ApplicationName"] = " ITAdmin ",
                ["DataProtection:KeysPath"] = " C:\\ITAdmin\\dataprotection-keys ",
        ...
        Assert.Equal("ITAdmin", settings.ApplicationName);
        Assert.Equal("C:\\ITAdmin\\dataprotection-keys", settings.KeysPath);
