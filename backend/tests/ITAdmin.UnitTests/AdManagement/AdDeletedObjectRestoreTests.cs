...
public sealed class AdDeletedObjectRestoreTests
{
    ...
    public void RestoreReadinessService_IsRegisteredInDependencyInjection()
    {
        var source = File.ReadAllText(
            Path.Combine(
                FindRepositoryRoot(),
                "backend/src/ITAdmin.Infrastructure/DependencyInjection.cs"));
    ...
    public void DeletedObjectRestoreService_UsesPowerShellRestoreAdObjectCommandRunner()
    {
        var restoreSource = File.ReadAllText(
            Path.Combine(
                FindRepositoryRoot(),
                "backend/src/ITAdmin.Infrastructure/Services/AdUserDirectoryService.DeletedObjectRestore.cs"));
        var runnerSource = File.ReadAllText(
            Path.Combine(
                FindRepositoryRoot(),
                "backend/src/ITAdmin.Infrastructure/Services/AdDeletedObjectRestorePowerShellCommandRunner.cs"));
    ...
    public void AdOperationLogService_PersistsWriteAsyncEntries()
    {
        var source = File.ReadAllText(
            Path.Combine(
                FindRepositoryRoot(),
                "backend/src/ITAdmin.Persistence/Services/AdOperationLogService.cs"));
    ...
    public void DeletedObjectRestoreFailureDiagnostic_IncludesOperationModeAndSourceTargetDns()
    {
        ...
        var diagnosticSource = File.ReadAllText(
            Path.Combine(
                FindRepositoryRoot(),
                "backend/src/ITAdmin.Application/Common/AdManagement/AdOperationErrorDiagnosticBuilder.cs"));
        var summarySource = File.ReadAllText(
            Path.Combine(
                FindRepositoryRoot(),
                "backend/src/ITAdmin.Application/Common/AdManagement/AdOperationLogSnapshotBuilder.cs"));
    ...
    public void DeletedObjectRestoreEndpoint_AcceptsOptionalRequestBody()
    {
        ...
        var contractSource = File.ReadAllText(
            Path.Combine(
                FindRepositoryRoot(),
                "backend/src/ITAdmin.Api/Contracts/AdManagement/AdDeletedObjectRestoreRequestBody.cs"));
