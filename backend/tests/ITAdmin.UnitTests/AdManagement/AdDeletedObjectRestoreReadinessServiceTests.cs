...
public sealed class AdDeletedObjectRestoreReadinessServiceTests
{
    ...
    public void ReadinessService_DoesNotContainRawTurkishUserFacingStrings()
    {
        var source = File.ReadAllText(
            Path.Combine(
                FindRepositoryRoot(),
                "backend/src/ITAdmin.Infrastructure/Services/AdDeletedObjectRestoreReadinessService.cs"));
    ...
    public void RestoreReadinessEndpoint_RequiresDeletedObjectsRestorePermission()
    {
        ...
        Assert.Equal(
            ITAdmin.Api.Authorization.RequirePermissionAttribute.PolicyPrefix
    ...
    public void SettingsValidationResponse_IncludesOptionalRestoreReadiness()
    {
        var source = File.ReadAllText(
            Path.Combine(
                FindRepositoryRoot(),
                "backend/src/ITAdmin.Api/Contracts/AdManagement/AdManagementValidationResponse.cs"));
