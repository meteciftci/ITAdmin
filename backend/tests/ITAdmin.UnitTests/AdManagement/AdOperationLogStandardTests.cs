...
public sealed class AdOperationLogStandardTests
{
    ...
    {
        var entity = new ITAdmin.Domain.Entities.AdManagementSettings
        {
            IsEnabled = true,
    ...
    {
        var before = new ITAdmin.Domain.Entities.AdAttributeMapping
        {
    ...
    {
        var entity = new ITAdmin.Domain.Entities.AdAttributeMapping
        {
