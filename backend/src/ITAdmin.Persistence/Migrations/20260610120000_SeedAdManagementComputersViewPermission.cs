...
{
    /// <inheritdoc />
    public partial class SeedAdManagementComputersViewPermission : Migration
    {
        private const string PermComputersView = "AdManagement.Computers.View";
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql($"""
                ...
                SELECT gen_random_uuid(), 'AdManagement', '{PermComputersView}', 'View AD management directory computers.', TRUE, NOW() AT TIME ZONE 'UTC', 'migration', FALSE
                WHERE NOT EXISTS (
                    SELECT 1 FROM portal_permissions WHERE code = '{PermComputersView}'
                );
                """);
            ...
            migrationBuilder.Sql($"""
                ...
                FROM portal_roles r
                JOIN portal_permissions p ON p.code = '{PermComputersView}'
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql($"""
                ...
                WHERE portal_permission_id IN (
                    SELECT id FROM portal_permissions WHERE code = '{PermComputersView}'
                );
                """);

            migrationBuilder.Sql($"""
                DELETE FROM portal_permissions
                WHERE code = '{PermComputersView}';
                """);
        }
    }
}
