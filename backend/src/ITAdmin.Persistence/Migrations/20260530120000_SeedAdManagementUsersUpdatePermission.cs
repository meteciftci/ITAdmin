...
{
    /// <inheritdoc />
    public partial class SeedAdManagementUsersUpdatePermission : Migration
    {
        private const string PermUsersUpdate = "AdManagement.Users.Update";
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql($"""
                ...
                SELECT gen_random_uuid(), 'AdManagement', '{PermUsersUpdate}', 'Update AD management directory users.', TRUE, NOW() AT TIME ZONE 'UTC', 'migration', FALSE
                WHERE NOT EXISTS (
                    SELECT 1 FROM portal_permissions WHERE code = '{PermUsersUpdate}'
                );
                """);
            ...
            migrationBuilder.Sql($"""
                ...
                FROM portal_roles r
                JOIN portal_permissions p ON p.code = '{PermUsersUpdate}'
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql($"""
                ...
                WHERE portal_permission_id IN (
                    SELECT id FROM portal_permissions WHERE code = '{PermUsersUpdate}'
                );
                """);

            migrationBuilder.Sql($"""
                DELETE FROM portal_permissions
                WHERE code = '{PermUsersUpdate}';
                """);
        }
    }
}
