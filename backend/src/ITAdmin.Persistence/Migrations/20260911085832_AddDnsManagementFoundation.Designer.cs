...
namespace ITAdmin.Persistence.Migrations
{
    ...
    [Migration("20260911085832_AddDnsManagementFoundation")]
    partial class AddDnsManagementFoundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsCredentialProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("dns_credential_profiles", (string)null);
                });

            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsInventorySnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("DnsServerId", "StartedAt");

                    b.ToTable("dns_inventory_snapshots", null, t =>
                        {
                            t.HasCheckConstraint("ck_dns_snapshots_active_completed", "NOT is_active OR (status = 'Completed' AND completed_at IS NOT NULL)");

                            t.HasCheckConstraint("ck_dns_snapshots_counts", "zone_count >= 0 AND record_count >= 0");
                        });
                });

            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsManagementSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("AutomaticSyncEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("automatic_sync_enabled");

                    b.Property<int>("CommandTimeoutSeconds")
                        .HasColumnType("integer")
                        .HasColumnName("command_timeout_seconds");

                    b.Property<int>("ComparisonSnapshotStaleAfterMinutes")
                        .HasColumnType("integer")
                        .HasColumnName("comparison_snapshot_stale_after_minutes");
                    ...
                    b.Property<int>("DefaultSyncIntervalMinutes")
                        .HasColumnType("integer")
                        .HasColumnName("default_sync_interval_minutes");

                    b.Property<int>("HealthCheckIntervalMinutes")
                        .HasColumnType("integer")
                        .HasColumnName("health_check_interval_minutes");

                    b.Property<bool>("IsEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("is_enabled");

                    b.Property<int>("MaxParallelServers")
                        .HasColumnType("integer")
                        .HasColumnName("max_parallel_servers");

                    b.Property<bool>("PromptForFullSyncOnComparisonOpen")
                        .HasColumnType("boolean")
                        .HasColumnName("prompt_for_full_sync_on_comparison_open");

                    b.Property<int>("SnapshotRetentionDays")
                        .HasColumnType("integer")
                        .HasColumnName("snapshot_retention_days");

                    b.Property<bool>("SyncRecordInventory")
                        .HasColumnType("boolean")
                        .HasColumnName("sync_record_inventory");
                    ...
                    b.ToTable("dns_management_settings", null, t =>
                        {
                            t.HasCheckConstraint("ck_dns_settings_command_timeout", "command_timeout_seconds BETWEEN 5 AND 300");

                            t.HasCheckConstraint("ck_dns_settings_health_interval", "health_check_interval_minutes BETWEEN 1 AND 1440");

                            t.HasCheckConstraint("ck_dns_settings_parallel_servers", "max_parallel_servers BETWEEN 1 AND 20");

                            t.HasCheckConstraint("ck_dns_settings_retention", "snapshot_retention_days BETWEEN 1 AND 3650");

                            t.HasCheckConstraint("ck_dns_settings_stale_after", "comparison_snapshot_stale_after_minutes BETWEEN 1 AND 10080");

                            t.HasCheckConstraint("ck_dns_settings_sync_interval", "default_sync_interval_minutes BETWEEN 1 AND 1440");
                        });
                });

            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsOperationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ServerDisplayName")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)")
                        .HasColumnName("server_display_name");
                    ...
                    b.HasIndex("DnsServerId", "CreatedAt");

                    b.ToTable("dns_operation_logs", (string)null);
                });

            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsRecordSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("DnsZoneSnapshotId")
                        .HasColumnType("uuid")
                        .HasColumnName("dns_zone_snapshot_id");
                    ...
                    b.Property<string>("RecordDataJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("record_data_json");
                    ...
                    b.Property<int>("TimeToLiveSeconds")
                        .HasColumnType("integer")
                        .HasColumnName("time_to_live_seconds");

                    b.Property<DateTime?>("Timestamp")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("timestamp");

                    b.Property<string>("VirtualizationInstance")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("virtualization_instance");

                    b.Property<string>("ZoneScope")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("zone_scope");

                    b.HasKey("Id");

                    b.HasIndex("RecordHash");

                    b.HasIndex("DnsZoneSnapshotId", "RelativeName", "RecordType");

                    b.ToTable("dns_record_snapshots", null, t =>
                        {
                            t.HasCheckConstraint("ck_dns_record_snapshots_ttl", "time_to_live_seconds >= 0");
                        });
                });

            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsServer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("DnsCredentialProfileId")
                        .HasColumnType("uuid")
                        .HasColumnName("dns_credential_profile_id");

                    b.Property<string>("DnsServerVersion")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("dns_server_version");
                    ...
                    b.Property<string>("TlsCertificateThumbprint")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("tls_certificate_thumbprint");
                    ...
                    b.HasIndex("DnsCredentialProfileId");

                    b.HasIndex("IsEnabled");

                    b.HasIndex("HostName", "Port")
                        .IsUnique();

                    b.ToTable("dns_servers", null, t =>
                        {
                            t.HasCheckConstraint("ck_dns_servers_port", "port BETWEEN 1 AND 65535");

                            t.HasCheckConstraint("ck_dns_servers_sync_interval", "sync_interval_minutes IS NULL OR sync_interval_minutes BETWEEN 1 AND 1440");
                        });
                });

            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsSyncJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("dns_sync_jobs", null, t =>
                        {
                            t.HasCheckConstraint("ck_dns_sync_jobs_attempt_count", "attempt_count >= 0");

                            t.HasCheckConstraint("ck_dns_sync_jobs_priority", "priority >= 0");
                        });
                });

            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsZoneSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DirectoryPartitionName")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("directory_partition_name");

                    b.Property<Guid>("DnsInventorySnapshotId")
                        .HasColumnType("uuid")
                        .HasColumnName("dns_inventory_snapshot_id");

                    b.Property<string>("DynamicUpdate")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("dynamic_update");

                    b.Property<bool>("IsDsIntegrated")
                        .HasColumnType("boolean")
                        .HasColumnName("is_ds_integrated");

                    b.Property<bool>("IsPaused")
                        .HasColumnType("boolean")
                        .HasColumnName("is_paused");

                    b.Property<bool>("IsReverseLookupZone")
                        .HasColumnType("boolean")
                        .HasColumnName("is_reverse_lookup_zone");
                    ...
                    b.Property<string>("ReplicationScope")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("replication_scope");
                    ...
                    b.Property<string>("ZoneFile")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("zone_file");
                    ...
                    b.HasIndex("DnsInventorySnapshotId", "Name");

                    b.ToTable("dns_zone_snapshots", (string)null);
                });
            ...
            modelBuilder.Entity("ITAdmin.Domain.Entities.LicenseRequestItemFulfillment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("license_request_item_fulfillments", (string)null);
                });
            ...
            modelBuilder.Entity("ITAdmin.Domain.Entities.LicenseSeatAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("SourceRequestItemId")
                        .HasColumnType("uuid")
                        .HasColumnName("source_request_item_id");
                    ...
                    b.ToTable("license_seat_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsInventorySnapshot", b =>
                {
                    b.HasOne("ITAdmin.Domain.Entities.DnsServer", "DnsServer")
            ...
            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsRecordSnapshot", b =>
                {
                    b.HasOne("ITAdmin.Domain.Entities.DnsZoneSnapshot", "ZoneSnapshot")
                        .WithMany("Records")
                        .HasForeignKey("DnsZoneSnapshotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ZoneSnapshot");
                });

            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsServer", b =>
                {
                    b.HasOne("ITAdmin.Domain.Entities.DnsCredentialProfile", "CredentialProfile")
                        .WithMany("Servers")
                        .HasForeignKey("DnsCredentialProfileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ITAdmin.Domain.Entities.DnsZoneSnapshot", b =>
                {
                    b.HasOne("ITAdmin.Domain.Entities.DnsInventorySnapshot", "InventorySnapshot")
                        .WithMany("Zones")
                        .HasForeignKey("DnsInventorySnapshotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ITAdmin.Domain.Entities.LicensePackage", b =>
                {
                    b.HasOne("ITAdmin.Domain.Entities.LicensePackage", "PreviousPackage")
                        .WithMany()
            ...
            modelBuilder.Entity("ITAdmin.Domain.Entities.LicenseRequestItemFulfillment", b =>
                {
                    b.HasOne("ITAdmin.Domain.Entities.LicensePackage", "Package")
            ...
            modelBuilder.Entity("ITAdmin.Domain.Entities.LicenseSeatAssignment", b =>
                {
                    ...
                    b.HasOne("ITAdmin.Domain.Entities.LicenseSeatAssignment", "ReplacesAssignment")
                        .WithMany()
