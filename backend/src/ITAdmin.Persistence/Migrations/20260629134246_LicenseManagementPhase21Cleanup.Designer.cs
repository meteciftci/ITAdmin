...
namespace ITAdmin.Persistence.Migrations
{
    ...
    [Migration("20260629134246_LicenseManagementPhase21Cleanup")]
    partial class LicenseManagementPhase21Cleanup
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ITAdmin.Domain.Entities.LicenseRequest", b =>
                {
                    ...
                    b.Property<string>("RequestedByAdObjectId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                    ...
                    b.Property<string>("RequestedByDepartment")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("requested_by_department");
                    ...
                    b.Property<string>("RequestedByMail")
                        .HasMaxLength(250)
                        .HasColumnType("character varying(250)")
                        .HasColumnName("requested_by_mail");

                    b.Property<string>("RequestedByManagerName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("requested_by_manager_name");
                    ...
                    b.Property<string>("RequestedBySamAccountName")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("requested_by_sam_account_name");

                    b.Property<string>("RequestedByTitle")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("requested_by_title");

                    b.Property<string>("RequestedByUserPrincipalName")
                        .HasMaxLength(250)
                        .HasColumnType("character varying(250)")
                        .HasColumnName("requested_by_user_principal_name");

                    b.Property<string>("RequesterUnit")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("requester_unit");
                    ...
                    b.HasIndex("RequestedByAdObjectId");
