    ...
    ILogger<SettingsService> logger) : ISettingsService
{
    ...
    private const string DefaultBrandingApplicationName = "ITAdmin";
    private const string DefaultBrandingBrowserTitle = "ITAdmin";
    ...
    private static string ResolveDefaultBrandingFooterText() =>
        string.Create(CultureInfo.InvariantCulture, $"© {DateTime.UtcNow.Year} ITAdmin");
