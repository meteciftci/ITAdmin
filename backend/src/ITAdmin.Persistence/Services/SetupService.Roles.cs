...
public sealed partial class SetupService
{
    ...
    [
        ...
        ("LicenseManagement", PermissionCodes.LicenseManagement.ViewSensitiveData, "View confidential license package data."),
        ...
        ("DnsManagement", PermissionCodes.DnsManagement.View, "View DNS management."),
        ("DnsManagement", PermissionCodes.DnsManagement.ManageSettings, "Manage DNS management settings."),
        ("DnsManagement", PermissionCodes.DnsManagement.Servers.View, "View registered DNS servers."),
        ("DnsManagement", PermissionCodes.DnsManagement.Servers.Manage, "Manage registered DNS servers and credential profiles."),
        ("DnsManagement", PermissionCodes.DnsManagement.Servers.TestConnection, "Test DNS server connections."),
        ("DnsManagement", PermissionCodes.DnsManagement.Zones.View, "View DNS zones."),
        ("DnsManagement", PermissionCodes.DnsManagement.Zones.Create, "Create DNS zones."),
        ("DnsManagement", PermissionCodes.DnsManagement.Zones.Update, "Update DNS zones."),
        ("DnsManagement", PermissionCodes.DnsManagement.Zones.Delete, "Delete DNS zones."),
        ("DnsManagement", PermissionCodes.DnsManagement.Records.View, "View DNS records."),
        ("DnsManagement", PermissionCodes.DnsManagement.Records.Create, "Create DNS records."),
        ("DnsManagement", PermissionCodes.DnsManagement.Records.Update, "Update DNS records."),
        ("DnsManagement", PermissionCodes.DnsManagement.Records.Delete, "Delete DNS records."),
        ("DnsManagement", PermissionCodes.DnsManagement.Compare, "Compare DNS inventory snapshots across servers."),
        ("DnsManagement", PermissionCodes.DnsManagement.Export, "Export DNS inventory and comparison results."),
        ("DnsManagement", PermissionCodes.DnsManagement.Synchronize, "Synchronize DNS server inventory."),
        ("DnsManagement", PermissionCodes.DnsManagement.ManageServerSettings, "Manage DNS server-wide settings."),
        ...
        ("DnsManagement", PermissionCodes.DnsManagement.ManageZoneDelegations, "Manage authoritative DNS zone delegations."),
