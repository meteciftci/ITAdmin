    ...
    ILogger<SetupService> logger) : ISetupService
{
    ...
    [
        ...
        ("AdManagement", "AdManagement.Computers.Groups.View", "View AD computer direct group memberships."),
        ...
        ("AdManagement", "AdManagement.OrganizationalUnits.View", "View AD management organizational units."),
        ("AdManagement", "AdManagement.OrganizationalUnits.Create", "Create AD management organizational units."),
        ("AdManagement", "AdManagement.OrganizationalUnits.Update", "Rename AD management organizational units."),
        ("AdManagement", "AdManagement.OrganizationalUnits.Move", "Move AD management organizational units."),
        ("AdManagement", "AdManagement.OrganizationalUnits.Delete", "Delete AD management organizational units."),
