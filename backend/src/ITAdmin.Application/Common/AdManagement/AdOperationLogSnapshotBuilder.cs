...
public static class AdOperationLogSnapshotBuilder
{
    ...
    public static string BuildDeletedObjectRestoreRequestSummary(
        ...
        string restoreRdn,
        string expectedRestoredDistinguishedName,
        string? originalLastKnownRdn = null,
        string? sourceDeletedDistinguishedName = null,
        string restoreOperationMode = "PowerShellRestoreAdObject",
        ...
        bool? sourceDnVerified = null)
    {
        ...
        return JsonSerializer.Serialize(
            new
            {
                ...
                restoreTargetMode = restoreTargetMode.ToString(),
                server,
                credentialMode,
                restoreTarget = new
                {
                    ...
                    restoreRdn,
                    expectedRestoredDistinguishedName,
                    restoredDistinguishedName = expectedRestoredDistinguishedName,
