...
const operations = ["InventorySynchronization", "ServerConnectionTest", "RecordCreate", "RecordUpdate", "RecordDelete", "ZoneCreate", "ZoneUpdate", "ZoneDelete", "ServerSettingsUpdate", "CacheClear", "PolicySaveClientSubnet", "PolicyDeleteClientSubnet", "PolicyCreateZoneScope", "PolicyDeleteZoneScope", "PolicySaveQueryPolicy", "PolicyDeleteQueryPolicy", "PolicySetQueryPolicyEnabled", "PolicySaveZoneTransferPolicy", "PolicyDeleteZoneTransferPolicy", "PolicySetZoneTransferPolicyEnabled", "DnssecZoneSign", "DnssecZoneResign", "DnssecZoneUnsign", "DnssecKeyRollover", "DnssecValidationUpdate", "DnssecRootTrustAnchorRetrieve", "DnssecDsTrustAnchorAdd", "DnssecDnsKeyTrustAnchorAdd", "DnssecTrustAnchorRemove", "DnsScavengingServerUpdate", "DnsZoneAgingUpdate", "DnsScavengingStart", "DnsListeningAddressesUpdate", "DnsRootHintAdd", "DnsRootHintUpdate", "DnsRootHintRemove", "ZoneTransferUpdate", "ZoneDelegationNameServerAdd", "ZoneDelegationNameServerUpdate", "ZoneDelegationNameServerRemove", "ZoneDelegationDelete"];
