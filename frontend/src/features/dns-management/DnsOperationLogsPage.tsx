...
const operations = ["InventorySynchronization", "ServerConnectionTest", "RecordCreate", "RecordUpdate", "RecordDelete", "ZoneCreate", "ZoneUpdate", "ZoneDelete", "ServerSettingsUpdate", "CacheClear", "PolicySaveClientSubnet", "PolicyDeleteClientSubnet", "PolicyCreateZoneScope", "PolicyDeleteZoneScope", "PolicySaveQueryPolicy", "PolicyDeleteQueryPolicy", "PolicySetQueryPolicyEnabled"];
