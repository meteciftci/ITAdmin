...
const operations = ["InventorySynchronization", "ServerConnectionTest", "RecordCreate", "RecordUpdate", "RecordDelete", "ZoneCreate", "ZoneUpdate", "ZoneDelete", "ServerSettingsUpdate", "CacheClear"];
