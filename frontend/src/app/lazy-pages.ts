...
export const DnsServerSettingsPage = lazy(() =>
  import("@/features/dns-management/DnsServerSettingsPage").then((module) => ({
    default: module.DnsServerSettingsPage,
  })),
);
...
export const DnsScavengingPage = lazy(() =>
  import("@/features/dns-management/DnsScavengingPage").then((module) => ({ default: module.DnsScavengingPage })),
);
...
export const DnsZoneDelegationsPage = lazy(() =>
  import("@/features/dns-management/DnsZoneDelegationsPage").then((module) => ({ default: module.DnsZoneDelegationsPage })),
);
...
export const DnsComparisonPage = lazy(() =>
  import("@/features/dns-management/DnsComparisonPage").then((module) => ({
...
export const LicenseSeatAssignmentsPage = lazy(() =>
  import("@/features/license-management/LicenseSeatAssignmentsPage").then((module) => ({
    default: module.LicenseSeatAssignmentsPage,
  })),
);
