...
import { DnsComparisonPage, DnsOperationLogsPage, DnsPoliciesPage, DnsServersPage, DnsServerSettingsPage, DnsZoneRecordsPage, DnsZonesPage, DnssecManagementPage } from "@/app/lazy-pages";
